 ...
 *
 */
public class ElementType_Recurso implements InterfaceOdaparser{
	...
	public ElementType_Recurso(CompleteGrammar Padre, LoadCollectionOda L) {

		AtributoMeta=new CompleteElementType(NameConstantsOda.RESOURCENAME, Padre);
		LColec=L;
CompleteOperationalView VistaOV=new CompleteOperationalView(NameConstantsOda.PRESNTACION); 
		...
		CompleteOperationalValueType ValorMeta=new CompleteOperationalValueType(NameConstantsOda.TYPE,NameConstantsOda.RESOURCENAME,VistaOVMeta);
